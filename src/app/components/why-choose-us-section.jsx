...
import { Bolt, TrendingUp, AccessTime, Psychology } from "@mui/icons-material"
  ...
  const benefits = [
    {
      icon: Bolt,
      stat: "75%",
      description: "faster note creation",
      color: "linear-gradient(to right, #facc15, #f97316)",
    },
    {
      icon: Psychology,
      stat: "90%",
      description: "improvement in information retrieval",
      color: "linear-gradient(to right, #4ade80, #10b981)",
    },
    {
      icon: TrendingUp,
      stat: "80%",
      description: "better follow-up completion",
      color: "linear-gradient(to right, #60a5fa, #06b6d4)",
    },
    {
      icon: AccessTime,
      stat: "65%",
      description: "reduction in information search",
